  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 lg:px-8 py-24 relative z-10">
      <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
        ...
        <p className="font-inter text-[18px] text-white/70 max-w-2xl leading-relaxed">
  ...
  return (
    <motion.div
      ...
      className={clsx(
        ...
        "bg-[#110e1a] border border-white/10 shadow-[0_0_20px_rgba(123,57,252,0.05)]",
    ...
    >
      <div className="absolute inset-0 z-0">
        {graphic}
        {fade.includes("top") && (
          <div className="absolute inset-0 bg-gradient-to-b from-[#110e1a] via-transparent to-transparent opacity-80" />
        )}
        {fade.includes("bottom") && (
          <div className="absolute inset-0 bg-gradient-to-t from-[#110e1a] via-transparent to-transparent opacity-80" />
        )}
      </div>
      <div className="relative p-10 z-20 mt-auto backdrop-blur-xl bg-[#110e1a]/60 border-t border-white/5 flex flex-col justify-end">
        <h3 className="font-manrope text-sm font-semibold tracking-wide uppercase text-[#a484d7] mb-2">
          {eyebrow}
        </h3>
        <p className="text-2xl font-medium tracking-tight text-white mb-3">
          {title}
        </p>
